...
class GaussianFeaturePrompt(Prompt):
    ...
    def update_model(self, inputs, targets):
        ...
        pseudo_mean = self.label_embedding[(targets - self.last_valid_out_dim).to(torch.int32),:]
    ...
    def create_label_embedding(self, task):
        ...
        self.label_embedding_optim = torch.optim.Adam(lr=0.001, params=[self.label_embedding])
