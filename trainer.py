...
class Trainer:
    ...
    def train(self, avg_metrics):
        ...
        print()
        print("*********************** SUMMARY *********************************")
        print(f"Model name: {self.model_name}, model type: {self.model_type}")
        print()
        print(f"Number of tasks: {self.num_tasks}, number of classes: {self.num_classes},")
        ...
        for i in range(self.max_task):
            ...
            try:
                ...
                self.learner.model.task_id = i  # starting index from 0!!!
